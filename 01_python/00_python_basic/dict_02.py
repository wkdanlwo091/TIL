...
web
"""
for key, value in t4ir_6th['language'].items():
    print(key)
...
신윤미
"""
for key, item in t4ir_6th['classes']['503'].items():
    print(item)
...
"""
print(t4ir_6th['language']['python']['frameworks'])
...
오늘의 당번은 최여진
"""
print(t4ir_6th['classes']['1305']['groups'])


my_dict = t4ir_6th['classes']['1305']['groups']
a, b  = random.choice(list(my_dict.items()))
person = random.choice(b)
